...
public class WindsweptLootTableProvider extends LootTableProvider {
    private final Pair<Supplier<Consumer<BiConsumer<ResourceLocation, Builder>>>, LootContextParamSet> blockTables = Pair.of(Blocks::new, LootContextParamSets.BLOCK);
    private final Pair<Supplier<Consumer<BiConsumer<ResourceLocation, Builder>>>, LootContextParamSet> entityTables = Pair.of(Entities::new, LootContextParamSets.ENTITY);
    private final Pair<Supplier<Consumer<BiConsumer<ResourceLocation, Builder>>>, LootContextParamSet> chestTables = Pair.of(Chests::new, LootContextParamSets.BLOCK);
    ...
    private static class Blocks extends BlockLoot {
        ...
        private static Builder dropTwoOthers(Block block, ItemLike other, ItemLike another) {
        ...
        private static Builder createPineconeTable(Block block) {
            return LootTable.lootTable()
        ...
        private static Builder createVerticalSlabItemTable(Block block) {
            return LootTable.lootTable()
                    .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1f))
                            .add(applyExplosionDecay(block, LootItem.lootTableItem(block)
    ...
    private static class Chests extends ChestLoot {
        ...
        private static void register(String name, Builder lootTable, BiConsumer<ResourceLocation, Builder> builder) {
